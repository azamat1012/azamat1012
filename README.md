...
<a href="https://github.com/azamat1012"><img src="https://img.shields.io/badge/GitHub-azamat1012-181717?style=for-the-badge&logo=github&logoColor=white" /></a>
...
Фрилансую с **ноября 2021**. Более 5 проектов полностью «под ключ» — e-commerce, образование, сервисы. Работал в командах по скраму. Не просто пишу код — закрываю задачу по полной.

<img align="right" src="https://github-readme-stats.vercel.app/api?username=azamat1012&show_icons=true&theme=radical&hide_title=true&hide_border=true&bg_color=0A0A0F&title_color=D4AF37&icon_color=D4AF37&text_color=A0A0B8&ring_color=D4AF37" width="420" />
...
**API:** REST · GraphQL · WebSockets · JWT · OAuth 2.0
...
**Интеграции:** Telegram Bot API · VK API · ЮKassa · Stripe · CloudPayments
...
|--------|------|------|--------|
| **nashles.kz** | Ведущий full-stack | Django · React · PostgreSQL · Redis | [↗](https://nashles.kz) |
| **treemov.ru** | Ведущий full-stack | Django · React · Docker | [↗](https://treemov.ru) |
| **ucs-service.ru** | Frontend | React · TypeScript | [↗](https://ucs-service.ru) |
...
> Django + React + PostgreSQL + Redis + Docker. Сложные роли, личные кабинеты, платежи. JWT-авторизация, Redis на горячих эндпоинтах — страницы грузятся **на 40% быстрее**. CI/CD с первого дня. **MVP за 3 месяца**, все заказы летают шустренько.

</details>

<details>
<summary><strong>📖 Telegram-бот мини-магазин</strong></summary>

> Node.js + ЮKassa внутри Telegram + ЭЦП для документов + админка + внешние API. Держит **тысячи сообщений в сутки**, автоматизировал 90% рутины.

</details>

<details>
<summary><strong>📖 Кроссплатформенное мобильное приложение</strong></summary>

> React Native + Redux. Две платформы одновременно: push-уведомления, личный кабинет, связь с бэком. Уложились в жёсткие сроки, код чистый.
...
Ноябрь 2021 ────► Настоящее время     Full-Stack Фриланс
                  ...
                  │                 Scrum-команды
                  │
              6 месяцев             1С-Битрикс / PHP
                  │                 Коммерческая разработка на проде
                  │
...
<img src="https://komarev.com/ghpvc/?username=azamat1012&color=D4AF37&style=flat-square&label=PROFILE+VIEWS" />
